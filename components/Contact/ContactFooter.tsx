...
export default function FooterContact() {
  ...
  return (
    <footer className="xl:hidden w-full px-6 py-12 mt-20 bg-black/20 backdrop-blur-sm">
      <div className="max-w-screen-xl mx-auto grid grid-cols-1 gap-10">
        {/* Contact Section */}
        ...
        <Link
          ...
          target="_blank"
          className="inline-flex items-center gap-2 bg-teal-400 hover:bg-teal-500 text-black px-4 py-2 rounded-lg transition-colors z-50 w-fit"
        >
